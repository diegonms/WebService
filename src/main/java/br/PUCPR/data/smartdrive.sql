...
CREATE TABLE AVALIACAO (
    ...
    CREATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT FK_AVALIACAO_ALUGUEL FOREIGN KEY (FK_ALUGUEL_ID) REFERENCES ALUGUEL(ID_ALUGUEL)
);
...
CREATE TABLE SEGURO (
    ...
    FK_ALUGUEL_ID INT NOT NULL,
    TIPO ENUM('BASICO', 'COMPLETO', 'PREMIUM') DEFAULT 'BASICO',
    ...
    CREATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT FK_SEGURO_ALUGUEL FOREIGN KEY (FK_ALUGUEL_ID) REFERENCES ALUGUEL(ID_ALUGUEL)
);
